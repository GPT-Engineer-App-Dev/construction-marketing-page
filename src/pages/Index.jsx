    ...
    <div className="font-sans">
      ...
      <section id="home" className="relative bg-cover bg-center h-screen" style={{ backgroundImage: "url('https://via.placeholder.com/1920x1080')" }}>
        ...
        <div className="relative z-10 text-center text-white flex flex-col items-center justify-center h-full">
          ...
          <p className="text-xl mb-8">Quality construction for modern living</p>
      ...
      <section id="about" className="p-8 bg-gray-100">
        ...
        <p className="max-w-2xl mx-auto text-center">We are a leading construction company committed to delivering high-quality projects that meet the needs of our clients. Our mission is to build structures that stand the test of time, with a focus on innovation, sustainability, and excellence.</p>
      </section>
      ...
      <section id="services" className="p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded shadow">
            ...
            <p>Building homes that are both beautiful and functional.</p>
          </div>
          <div className="bg-white p-6 rounded shadow">
            <h3 className="text-xl font-bold mb-2">Commercial Construction</h3>
            <p>Creating commercial spaces that meet business needs.</p>
          </div>
          <div className="bg-white p-6 rounded shadow">
            <h3 className="text-xl font-bold mb-2">Renovations</h3>
            <p>Transforming existing spaces to meet new demands.</p>
          </div>
        </div>
      </section>
