  ...
  return (
    <div className="font-sans">
      ...
      <section id="about" className="p-8 bg-gray-100">
        ...
        <p className="max-w-2xl mx-auto text-center">We are a leading construction company dedicated to providing top-notch services to our clients. Our mission is to build high-quality structures that stand the test of time. We value integrity, excellence, and customer satisfaction.</p>
      </section>
      ...
      <section id="services" className="p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-6 rounded shadow">
            ...
            <p>Transforming existing spaces to meet modern standards.</p>
          </div>
        </div>
      </section>
